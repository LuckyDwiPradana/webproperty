...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('/admin/compiled/css/error.css') ?>">
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            <img class="img-error" src="<?= base_url() ?>/admin/compiled/svg/error-500.svg" alt="Not Found">
            <h1 class="error-title">Kesalahan Sistem</h1>
            <p class="fs-5 text-gray-600">Sistem saat ini tidak tersedia. Silakan coba lagi nanti.</p>
            <a href="<?= site_url('/') ?>" class="btn btn-lg btn-outline-primary mt-3">Kembali</a>
        </div>
    </div>
</div>
