...
<html lang="en">
    ...
    <title>Tambah Kesepakatan</title>
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Kesepakatan</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Kesepakatan</h4>
                </div>
                       ...
                       <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date" name="date" value="<?= old('date') ?>" required placeholder="Masukkan Tanggal">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                 ...
                                 <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="buyer_name" name="buyer_name" value="<?= old('buyer_name') ?>" required placeholder="Masukkan Nama Pembeli">
                                    </div>
                                </div>
                                 <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="price">Harga</label>
                                        <input type="number" class="form-control" id="price" name="price" value="<?= old('price') ?>" required placeholder="Masukkan Harga">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="closing_description">Deskripsi Penutupan</label>
                                        <textarea class="form-control" id="closing_description" name="closing_description" required placeholder="Masukkan Deskripsi Penutupan"><?= old('closing_description') ?></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="documentation">Dokumentasi</label>
                                        <input type="file" class="form-control" id="documentation"  aria-label="Upload" required name="documentation">
                                    </div>
                                </div>
