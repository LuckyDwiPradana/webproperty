            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Kunjugan</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <?= form_open_multipart('/admin/showings/store') ?>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="activity_name" name="activity_name" value="<?= old('activity_name') ?>" required placeholder="Masukkan Nama Aktivitas">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="activity_description">Deskripsi Aktivitas</label>
                                    <textarea class="form-control" id="activity_description" name="activity_description" required placeholder="Masukkan Deskripsi Aktivitas"><?= old('activity_description') ?></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="activity_result">Hasil Aktivitas</label>
                                    <textarea class="form-control" id="activity_result" name="activity_result" required placeholder="Masukkan Hasil Aktivitas"><?= old('activity_result') ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                              ...
                              <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="photos" name="photos[]" required aria-label="Upload" multiple>
                                    </div>
                                </div>
                            </div>
