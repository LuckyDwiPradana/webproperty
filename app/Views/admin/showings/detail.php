            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/showings/index">Kunjungan</a></li>
 ...
 <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?= esc($showing['Activity_name']) ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h6>Informasi Dasar</h6>
                                    <p><strong>Nama:</strong> <?= esc($showing['Activity_name']) ?></p>
                                    <p><strong>Tanggal:</strong> <?= esc($showing['Date']) ?></p>
                                    <p><strong>Properti:</strong> <?= esc($showing['property_name']) ?></p>
                                    <p><strong>Agent:</strong> <?= esc($showing['agent_name']) ?></p>
                                </div>
                             <!-- Tambahkan bagian informasi agen -->
                             <div class="col-md-6">
                                    <h6>Deskripsi Kunjungan</h6>
                                    <p><strong>Hasil Kunjungan:</strong> <?= esc($showing['Activity_result']) ?></p>
                                </div>
                            </div>
                             <div class="row mt-4">
                                <div class="col-12">
                                    <h6>Deskripsi Aktivitas</h6>
                                    <p><?= nl2br(esc($showing['Activity_description'])) ?></p>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col-12">
                                    ...
                                    <?php if (!empty($showing['photos'])): ?>
                                        <div id="propertyCarousel" class="carousel slide" data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <?php foreach ($showing['photos'] as $index => $photo): ?>
                                                    <div class="carousel-item <?= $index === 0 ? 'active' : '' ?>">
                                                        <img src="<?= esc($photo['url']) ?>" class="d-block w-100" alt="Foto Showing">
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
