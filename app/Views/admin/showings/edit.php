            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Kunjugan</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <?= form_open_multipart('/admin/showings/update/' . $showing['id']) ?>
                                    <?= csrf_field() ?>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <div class="row justify-content-center">
                                        ...
                                        $photos = is_string($showing['photos']) ? json_decode($showing['photos'], true) : $showing['photos'];
                                        if (!empty($photos)): ?>
                                            <div id="showingCarousel<?= ($showing['id']) ?>" class="carousel slide carousel-item-container" data-bs-ride="carousel" style="max-width: 500px;">
                                                <div class="carousel-inner">
                                                    <?php $active = true; ?>
                                                    <?php foreach ($photos as $photo): ?>
                                                        <div class="carousel-item <?= $active ? 'active' : '' ?>">
                                                            <img src="<?= ($photo['url']) ?>" class="d-block mx-auto img-thumbnail" alt="Property Photo" style="max-height: 300px;">
                                                        </div>
                                                        <?php $active = false; ?>
                                                    <?php endforeach; ?>
                                                </div>
                                                <a class="carousel-control-prev" href="#showingCarousel<?= ($showing['id']) ?>" role="button" data-bs-slide="prev" style="width: 5%;">
                                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                    <span class="visually-hidden">Previous</span>
                                                </a>
                                                <a class="carousel-control-next" href="#showingCarousel<?= ($showing['id']) ?>" role="button" data-bs-slide="next" style="width: 5%;">
