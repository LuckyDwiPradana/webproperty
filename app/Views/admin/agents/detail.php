            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/agents/index">Agen</a></li>
 ...
 <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?= esc($agent['agent_name']) ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <h6>Informasi Dasar</h6>
                                    <p><strong>Nama:</strong> <?= esc($agent['agent_name']) ?></p>
                                    <p><strong>Email:</strong> <?= esc($agent['email']) ?></p>
                                    <p><strong>Nomor Telepon:</strong> <?= esc($agent['phone_number']) ?></p>
                                    <p><strong>Alamat:</strong> <?= esc($agent['address']) ?></p>
                                </div>
                             <!-- Tambahkan bagian informasi agen -->
                             <div class="col-md-6">
                                    <h6>Media Sosial</h6>
                                    <p><strong>Facebook:</strong> <?= esc($agent['facebook']) ?></p>
                                    <p><strong>TikTok:</strong> <?= esc($agent['tiktok']) ?></p>
                                    <p><strong>Instagram:</strong> <?= esc($agent['instagram']) ?></p>
                                </div>
                            </div>
                             <div class="row mt-4">
                            <div class="col-12">
                                ...
                                <?php if (isset($agent['agent_photo_url']) && !empty($agent['agent_photo_url'])): ?>
                                    <img src="<?= esc($agent['agent_photo_url']) ?>" alt="Foto Agen" class="img-fluid" style="max-width: 300px;">
                                <?php else: ?>
