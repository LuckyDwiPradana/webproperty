                ...
                <?php if (!empty($showings)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                                                            ...
                                                            <?php foreach ($showing['photos'] as $key => $photo): ?>
                                                                <div class="carousel-item <?= $active ? 'active' : '' ?>" data-bs-slide-to="<?= $key ?>">
                                                                    <a href="#" data-toggle="modal" data-target="#photoModal<?= esc($showing['id']) ?>" data-slide-to="<?= $key ?>">
                                                                        <img src="<?= esc($photo['url']) ?>"alt="Showing Photo" style="width: 100px; height: 75px; object-fit: cover;">                                                                    </a>
                                                                </div>
                                                                <?php $active = false; ?>
                                                            <?php endforeach; ?>
                                                        </div>
                                                ...
                                                <?php endif; ?>
                                           <td>
                                                <a href="/agent/showings/detail/<?= esc($showing['id']) ?>" class="btn btn-info btn-sm">Lihat</a>
                                                <a href="/agent/showings/edit/<?= esc($showing['id']) ?>" class="btn btn-primary btn-sm">Edit</a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="/agent/showings/delete/<?= esc($showing['id']) ?>" method="post" class="d-inline">
                                                                    <?= csrf_field() ?>
