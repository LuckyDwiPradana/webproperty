...
<style>
.card-equal-height {
    min-height: 150px; /* Sesuaikan dengan tinggi minimum yang diinginkan */
    display: flex;
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    <div class="avatar avatar-xl">
                                        <img src="<?= base_url('sesuaikan dengan server') ?>" alt="Face 1">
                                    </div>
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">sesuikan server</h5>
                                        <h6 class="text-muted mb-0">sesuaikan server</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
